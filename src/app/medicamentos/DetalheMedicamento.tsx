...
export default function DetalheMedicamento() {
  ...
  const [setReceitaSelecionada] = useState<any | null>(null);
  ...
  const finalizarCompra = () => {
    ...
    router.navigate("/medicamentos/medicamentos");
  };
 
  // NOVO: confirma a receita imediatamente ao clicar
  const confirmarReceita = () => {
    if (!produto.receitaObrigatoria) return;
    setReceitaCarregada(true);
  };
 
  // Mantém o efeito de verificar receita selecionada ao voltar da tela (caso ainda tenha AsyncStorage)
  ...
  return (
    <View style={styles.container}>
      ...
      {/* BOTÃO MODIFICADO: confirma receita instantaneamente */}
      {produto.receitaObrigatoria && !receitaCarregada && (
        <TouchableOpacity
